...
public class DynamicView {
    ...
    private static final int INTERNAL_TAG_ID = 0x7f020000;
     ...
     */
    public static View createView (@NonNull Context context, JSONObject jsonObject, Class holderClass) {
     ...
     * @return the view that created
     */
    private static View createView(@NonNull Context context, JSONObject jsonObject, ViewGroup parent, Class holderClass) {
     ...
     * @return the view that created
     */
    public static View createView (@NonNull Context context, JSONObject jsonObject, ViewGroup parent) {
     ...
     * @return the view that created
     */
    public static View createView (@NonNull Context context, JSONObject jsonObject) {
     ...
     * @return the view that created
     */
    private static View createViewInternal (@NonNull Context context, JSONObject jsonObject, ViewGroup parent, HashMap<String, Integer> ids) {
        View view = null;
